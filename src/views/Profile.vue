<template>
    <section class="bg-gray w-screen p-20 flex flex-col justify-center items-center">
        ...
        <div class="flex justify-center flex-wrap py-3">
            <Portfolio v-for="(item,index) in portfolio" :thumbnail="item.thumbnail" :title="item.title" :content="item.content"
        ...
        <Detail v-if="showDetail" @close="showDetail=false">
            ...
            <swiper :options="swiperOption" slot="img">
                <swiper-slide v-for="item in portfolio[showDetailIndex].img"><img :src="require(`@/assets/images/portfolio/${item}`)"/></swiper-slide>
